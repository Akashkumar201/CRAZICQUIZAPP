...
import com.example.trivialapp.controller.AppController;
...
public class QuestionBank {
  ...
  public   List<Question> getQuestions(final AnswerListAnsyncResponse callBack){
        ...
        public void onResponse(JSONArray response) {
         for(int i=0;i<response.length();i++){
             ...
             try {
                ...
                // Log.d("hope","onResponse: "+question.getAnswer());
